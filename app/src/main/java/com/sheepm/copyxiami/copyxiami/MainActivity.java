package com.sheepm.copyxiami.copyxiami;
...
import com.sheepm.copyxiami.Utils.SlidingMenu;
import com.sheepm.copyxiami.activity.MusicActivity;
import com.sheepm.copyxiami.application.Myapp;
import com.sheepm.copyxiami.bean.Mp3Info;
import com.sheepm.copyxiami.fragment.MainFragment;
...
//	private boolean isPlay = false;
	...
	private void setNotification() {
		...
		// 4������context, requestCode, intent, flags
		...
		builder.setSmallIcon(R.drawable.notification_bar_icon); // ���ö���ͼ��

		Notification notify = builder.build();
		notify.contentView = remoteViews; // ��������ͼ��
		notify.bigContentView = remoteViews; // ��ֹ��ʾ����ȫ,��Ҫ���apisupport
